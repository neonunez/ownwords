  ...
  if (state.error || !state.data) {
    return (
      <>
        {header}
        <Failed
          message="The alphabet could not be read. Nothing was lost."
  ...
  return (
    <>
      ...
      <Screen style={{ gap: 14 }}>
            ...
            <li key={letter.upper}>
              <Card
                ...
                style={{
                  ...
                  minHeight: 88,
                  alignContent: "center",
                  borderColor: letter.trap
                    ? "var(--state-false-friend)"
                    : undefined,
                }}
              >
                <span
                ...
                >
                  {letter.upper}
                  <span style={{ fontSize: "1.25rem", color: "var(--fg-3)" }}>
                    {letter.lower}
                  </span>
                </span>
                <span
                  aria-hidden="true"
                  style={{ font: "var(--type-caption)", color: "var(--fg-2)" }}
                >
                  {letter.sound}
                </span>
                {letter.trap && (
        ...
        <Note>
          Stress is written with the combining acute in the course. You never
          have to type it, and search ignores it.
        </Note>
      </Screen>
    </>
  );
