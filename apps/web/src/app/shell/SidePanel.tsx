 ...
 */
export function SidePanel({ open, onClose, mode, onModeChange, languages }: SidePanelProps) {
        ...
        >
          ...
          <Section title="Languages">
              ...
              {languages.map((language, index) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '11px 14px',
                    minHeight: 44,
                    borderBottom: index < languages.length - 1 ? '1px solid var(--border-1)' : 0,
                    font: 'var(--type-body)',
                    fontSize: '.9375rem',
                  }}
                >
            ...
            <Button
              ...
              size="sm"
              icon="plus"
              onClick={() => showToast('Adding a language arrives with the account backend.')}
            >
              Add a language
            </Button>
          </Section>
          ...
          <Section title="Preferences">
            <Card padding={0}>
              <div style={row(true)}>
                ...
                <span style={{ font: 'var(--type-caption)', color: 'var(--fg-3)' }}>
                  {languages.find((language) => language.code === preferences?.explanationsIn)?.name ??
                    'English'}
                </span>
              </div>
              <div style={row(true)}>
              ...
              <div style={row(true)}>
                ...
                <span>Reminders</span>
                <span style={{ font: 'var(--type-caption)', color: 'var(--fg-3)' }}>After install</span>
              </div>
              <div
                style={{
                  display: 'grid',
              ...
              >
                <Icon name={appearance === 'dark' ? 'moon' : 'sun'} size={18} color="var(--fg-3)" />
          ...
          <div style={{ display: 'grid', gap: 4 }}>
            <Button
              ...
              onClick={() => showToast('Export arrives with the account backend.')}
            >
              Export my data
            </Button>
            <Button
              ...
              icon="user"
              style={{ justifyContent: 'flex-start' }}
              onClick={() => showToast('Sign-in arrives with the account backend.')}
            >
              Account
            </Button>
          </div>
          ...
          <p style={{ margin: 0, padding: '0 4px', font: 'var(--type-caption)', color: 'var(--fg-3)' }}>
            Your collection lives in this browser for now. Nothing is sent anywhere, and nothing is kept
